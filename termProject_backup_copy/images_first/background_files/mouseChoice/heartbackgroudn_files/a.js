...
document.writeln('<script type="text/javascript"><!--');
document.writeln('google_ad_client = "ca-pub-4213001413639273";');
document.writeln('google_ad_slot = "1857775191";');
...
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="gg300x250_3"){
document.writeln('<script>var cpro_id = "u82108";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb160x600"){
document.writeln('<script>var cpro_id = "u87620";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb728x90_1"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "372923";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
if (code=="lb728x90_2"){
...
if (code=="egg"){// egg
document.write('* 懒人图库承诺：本站所有资源免费下载，无病毒，无弹窗，无干扰链接！ <a href="http://www.lanrentuku.com/about/guestbook.html" target="_blank">提点建议</a>');}
if (code=="jinbu"){// 进步
document.write('<dd>03月01日 折页网上线 http://zheye.cc/</dd>');
document.write('<dd>09月20日 在线留言启用多说系统</dd>');
document.write('<dd>07月23日 PNG图标文章页增加精彩推荐</dd>');
document.write('<dd>05月07日 新增8种网页背景图片</dd>');
