...
##------------the part for object tracking ------------------------------##
    ...
    def initScoreRecord(self):
        ...
        try:
            ...
            print self.presentScore[-1]
        except:
            print "The file does not exist yet (as we hoped!)"

    def getHighestScore(scoreString):
        s=scoreString.split(',')
    ...
    def mousePressed(self,event):
        ...
        if self.screen == "Menu":
            ...
            if x>0 and x<900 and y>0 and y<500:
                self.screen="Menu"
...
####-------------------this part is realted to playing music --------------####
    ...
    def drawLevel1(self,canvas):
        canvas.create_image(500,200,image=self.level1BackGroundImage)
    ...
    def drawMenu(self,canvas):
        ...
        canvas.create_image(430,260,image=self.backGroundImage)
