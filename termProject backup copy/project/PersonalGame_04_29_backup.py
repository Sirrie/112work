...
class Game(Animation):
    def init(self):
        ...
        self.otherWeapens=[]
        self.weapenLife=0
        # new weapen only have 10 bullets when u used up them you can only use 
        # spit
        self.weapenLife  =10 
   ...
   # code from David Kosbie's lecture note 
    ...
    def mousePressed(self,event):
        ...
        if self.screen == "Menu":
            ...
            if x>0 and x<self.witdth and y>0 and y<self.height:
                self.screen="Menu"
    ...
    def keyPressed(self,event):
        ...
        if(event.char=="r"):
            ...
            self.playMenuMusic()
            self.isGameOver=False
            print self.isMenuMusicOn,"the menuMusic",self.isGameOverMusicOn
...
####----------------this par relate with drawing ------------------###
    def drawHighScoreBoard(self,canvas):
        ...
        canvas.create_text(widthCellSize*(2+1),hightCellSize,text="HighScoreBoard",font="Helvetica 30 bold",fill="snow")
        canvas.create_text(widthCellSize*2,hightCellSize*2,text="Name",font ="Helvetica 26 bold",fill="snow")
        canvas.create_text(widthCellSize*2*2,hightCellSize*2,text="Score",font="Hwlvetica 26 bold",fill="snow")
    ...
    def drawGameOver(self,canvas):
        ...
        canvas.create_text(720,450,font="Helvetica 30 bold",activefill="MediumVioletRed",fill="OrangeRed",text="Show HighScore")

    def drawMenu(self,canvas):
        canvas.create_image(450,260,image=self.backGroundImage)
        canvas.create_text(600,250,font="Helvetica 30 bold",activefill="Lime",fill="Black",text="Start")
        canvas.create_text(100,450,font="Helvetica 30 bold",activefill="Lime",fill="Black",text="Guide")
        canvas.create_text(800,450,font="Helvetica 30 bold",activefill="Lime",fill="Black",text="Difficulty")
